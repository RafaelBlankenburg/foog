 ...
 * [foog.yml](foog.yml)
     * Determines how your purl.obolibrary.org/obo/foog/ redirects will be handled
     ...
     * Paste in the contents of [foog.yml](foog.yml)
 ...
 * [foog.md](foog.md)
     ...
     * Paste in the contents of [foog.md](foog.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
